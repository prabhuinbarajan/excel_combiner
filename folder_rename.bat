...
> "\\sclbonas01\DATA\ERP\Accounting\General Ledger\Period End Close\Host Analytics\logs\folder_rename_consol_log-%app_env%-%DATE:~-4%-%DATE:~4,2%-%DATE:~7,2%_%hh%%time:~3,2%%time:~6,2%.txt" 2>&1 (
